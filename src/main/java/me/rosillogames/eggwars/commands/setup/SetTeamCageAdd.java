...
public class SetTeamCageAdd extends CommandArg
{
    ...
    public boolean execute(CommandSender sender, String[] args)
    {
        ...
        arena.getTeams().get(teamtype).addCage(player.getLocation());
        TranslationUtils.sendMessage("commands.addTeamCage.success", sender, teamtype.id());

...
public class SetTeamVillager extends CommandArg
{
    ...
    public boolean execute(CommandSender sender, String[] args)
    {
        ...
        arena.getTeams().get(teamtype).setVillager(player.getLocation());
        TranslationUtils.sendMessage("commands.setTeamVillager.success", sender, teamtype.id());

...
public class SetMaxPlayersPerTeam extends CommandArg
{
    public SetMaxPlayersPerTeam()
    {
        super(true);
    }
    ...
    public boolean execute(CommandSender commandSender, String[] args)
    {
        if (args.length != 2)
        {
            TranslationUtils.sendMessage("commands.setMaxPlayersPerTeam.usage", commandSender);
            return false;
        }
        ...
        arena.setMaxTeamPlayers(Integer.parseInt(args[1]));
        TranslationUtils.sendMessage("commands.setMaxPlayersPerTeam.success", commandSender, arena.getName());
